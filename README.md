...
3. Layout Inheritance (Kế thừa Giao diện)
...
│   └── public/                     # Trang chủ & Chi tiết việc làm cho ứng viên 
routes/
...
Cấu hình môi trường: Copy .env.example thành .env và cấu hình DB_DATABASE=vieclam.
